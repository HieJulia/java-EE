...
function buyClick(type){
	...
	var para="?movieID="+movieID+"&playTime="+movieTime+"&cinemaName="+cinemaName+"&movieTotalPrice="+movieTotalPrice+"&seats="+seats+ "&area=" + cinemaArea;
	
	if(type=="buy"){
		window.location.href="/CinemaTicket/PaymentServlet"+para;
	}
	else{
		window.location.href="/CinemaTicket/CartServlet"+para;
	}
}
